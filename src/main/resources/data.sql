...
insert into item_tb (item_name, price, quantity, account_id) values('test1', 1000, 10, 1);
insert into item_tb (item_name, price, quantity, account_id) values('test2', 9999, 20, 1);
